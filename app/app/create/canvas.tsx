    ...
    <div className="" ref={setNodeRef} style={style} {...attributes}>
      <div className=" flex h-full w-full items-center">
        ...
        <div className=" relative flex h-28 w-full items-center justify-center gap-2 rounded-md bg-gray-400 font-bold dark:bg-gray-600">
          <p>component</p>
          <p>{props.id} </p>
          <div className="absolute bottom-0 left-0 right-0 top-0 flex items-center justify-center gap-4 rounded-md bg-lightTransparent opacity-0 transition-opacity delay-300 hover:opacity-100 hover:backdrop-blur dark:bg-darkTransparent">
            <Button
              onClick={() => {
                console.log("clicked");
